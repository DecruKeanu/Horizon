...
void SinglePlayerLevel::NextLevel()
{
	...
	(m_Level == 3) ? Horizon::SceneManager::GetInstance().AddScene(new MainMenuScene()) : Horizon::SceneManager::GetInstance().AddScene(new SinglePlayerLevel(++m_Level, LevelType::SinglePlayer, m_PlayerScore, m_PlayerLives));
