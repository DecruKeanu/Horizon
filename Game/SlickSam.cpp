...
void SlickSam::Initialize()
{
	...
	GameObject* const pGameObject = new GameObject("SlickSam", float(rand() % 10 + 20));
	...
	//EnemyMovementComponent* const pMovementComponent = new EnemyMovementComponent(pGameObject, IPoint2{ positionX,positionY + 200 }, IPoint2{ 32, 48 },true);
