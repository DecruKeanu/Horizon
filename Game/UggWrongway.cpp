...
void UggWrongway::Initialize()
{
	...
	GameObject* const pGameObject = new GameObject("UggWrongway"/*, float(rand() % 10 + 20)*/);
	...
	//EnemyMovementComponent* const pMovementComponent = new EnemyMovementComponent(pGameObject, IPoint2{ positionX,positionY }, { 32,50 }, false);
	//EnemyInputComponent* const pInputComponent = new EnemyInputComponent(pGameObject, IPoint2{ movementDirectionX,-1 });
